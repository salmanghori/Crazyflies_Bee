...
def upload_trajectory(scf, trajectory_id, trajectory):
    trajectory_mem = scf.mem.get_mems(MemoryElement.TYPE_TRAJ)[0]
    ...
    scf.high_level_commander.define_trajectory(trajectory_id, 0,
                                              len(trajectory_mem.poly4Ds))
    return total_duration


def run_shared_sequence(scf, trajectory_id, duration, seq_args):
